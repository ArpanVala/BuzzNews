                ...
                <div className="explore-topics p-4">
                    <div className="row">
                        ...
                        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-2 gy-4  g-sm-3 mt-0">
                            <div className="col"><Button icon={"fa-solid fa-film"} text={"Entertainment"} /></div>
                            <div className="col"><Button icon={"fa-solid fa-basketball"} text={"Sports"} /></div>
                            <div className="col"><Button icon={"fa-solid fa-briefcase"} text={"Business"} /></div>
                            <div className="col"><Button icon={"fa-solid fa-microchip"} text={"Technology"} /></div>
                            <div className="col"><Button icon={"fa-solid fa-flask"} text={"Science"} /></div>
                            <div className="col"><Button icon={"fa-solid fa-heart-pulse"} text={"Health"} /></div>
                        </div>
                    </div>
                </div>
            </section>
